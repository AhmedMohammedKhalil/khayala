<div style="margin: 80px 0;min-height: 30vh" >
    <div class="row">
        <div class="single-feedback">
            ...
            @auth('trainer')
            <a href="{{ route('trainer.booking.edit',['id'=>$booking->id]) }}" class="btn btn-primary">تعديل</a>
            <a href="{{ route('trainer.booking.delete',['id'=>$booking->id]) }}" class="btn btn-primary">حذف</a>
        @endauth
        </div>
    </div>
</div>
