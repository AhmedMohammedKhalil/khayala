    ...
    <div class="row">
        <div class="single-feedback">
            <div class="client-info pt-3">
                ...
                <span>المدرب : {{ $booking->trainer->name }}</span>
        ...
        @if(auth('user')->user()->id == $booking->user_id)
            <a style="    display: block; width: fit-content;margin: 20px auto;" href="{{ route('user.trainerbooking.del',['id'=>$booking->id]) }}" class="btn btn-primary">حذف الميعاد</a>
        @endif
        @endauth
    </div>
</div>
