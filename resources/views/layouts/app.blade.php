                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    <div class="collapse navbar-collapse mean-menu w-auto" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-0 flex-row-reverse p-0">
                            <li class="nav-item"><a href="{{ route('search') }}" class="nav-link">بحث</a></li>
                            <li class="nav-item"><a href="{{ route('competitons') }}" class="nav-link">المسابقات</a></li>
                            ...
                            @if(!auth('doctor')->check() && !auth('trainer')->check() && !auth('admin')->check() && !auth('user')->check())
                                ...
                                <li class="nav-item"><a href="#" class="nav-link">تسجيل دخول <i class="icofont-simple-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="{{ route('admin.login') }}" class="nav-link">الأدمن</a></li>
                                        <li class="nav-item"><a href="{{ route('doctor.login') }}" class="nav-link">الدكتور</a></li>
                                        <li class="nav-item"><a href="{{ route('trainer.login') }}" class="nav-link">المدرب</a></li>
                                        <li class="nav-item"><a href="{{ route('user.login') }}" class="nav-link">المستخدم</a></li>
                            ...
                            @auth('admin')
                                <li class="nav-item text-center"><a href="#" class="nav-link">{{ Auth::guard('admin')->user()->name }} <i class="icofont-simple-down"></i></a>
                                    <ul class="dropdown-menu ">
                                        ...
                                        <li class="nav-item"><a href="{{ route('admin.logout') }}" class="nav-link">خروج</a></li>
                                    </ul>
                                </li>
                            @endauth
                            @auth('doctor')
                                <li class="nav-item text-center"><a href="#" class="nav-link">{{ Auth::guard('doctor')->user()->name }} <i class="icofont-simple-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="{{ route('doctor.profile') }}" class="nav-link">البروفايل</a></li>
                                        <li class="nav-item"><a href="{{ route('doctor.logout') }}" class="nav-link">خروج</a></li>
                                    </ul>
                                </li>
                            @endauth
                            @auth('trainer')
                                <li class="nav-item"><a href="#" class="nav-link">{{ Auth::guard('trainer')->user()->name }} <i class="icofont-simple-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="{{ route('trainer.profile') }}" class="nav-link">البروفايل</a></li>
                                        <li class="nav-item"><a href="{{ route('trainer.logout') }}" class="nav-link">خروج</a></li>
                                    </ul>
                                </li>
                            @endauth
                            @auth('user')
                                <li class="nav-item"><a href="#" class="nav-link">{{ Auth::guard('user')->user()->name }} <i class="icofont-simple-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="{{ route('user.profile') }}" class="nav-link">البروفايل</a></li>
                                        <li class="nav-item"><a href="{{ route('user.logout') }}" class="nav-link">خروج</a></li>
                                    </ul>
                                </li>
                            @endauth
