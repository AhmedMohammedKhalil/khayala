    ...
    <div class="d-table" style="">
        <div class="d-table-cell">
            <div class="login-form">
                <h3>إنشئ حساب أو <a href="{{ route('trainer.login') }}" class="text-decoration-underline"> سجل الان </a></h3>
                ...
                <form wire:submit.prevent='register'>
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            <input type="text" wire:model.lazy='specialization' id="specialization" class="form-control" placeholder="التخصص">
