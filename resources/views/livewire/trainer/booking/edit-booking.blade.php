        ...
        <form wire:submit.prevent='edit'>
            ...
            <div class="form-group">
                <select class="form-control ps-2" wire:model.lazy='status' name="status" id="status">
                    <option value="1" @if($status == 1) selected @endif>ميعاد متاح</option>
                    <option value="0" @if($status == 0) selected @endif>ميعاد محجوز</option>
                </select>
            ...
            <div class="form-group">
                <input type="datetime-local" class="form-control ps-2" wire:model.lazy='end' name="end" id="end" placeholder="نهاية الميعاد">
